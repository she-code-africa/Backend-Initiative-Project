...
def user():
    if "user" in session:
        ...
        if request.method == "PUT":
            update_user = request.form["Update User"]
    ...
    if request.method == "POST":
        ...
        if "movie" in session:
            ...
            if request.method == "GET":
                ...
                update_movie = request.form["Update Movie"]
...
def rental():
    if request.method == "POST":
        ...
        for find_rental in movies:
            if find_rental == movie:
        ...
        if "rental" in session:
            ...
            if request.method == "GET":
                ...
                update_rental = request.form["Update Rental"]
            ...
            return jsonify({"status": "Failure", "ERROR": "Movie not found", "Movies available": rentals}), 200
